...
class WebsiteSale(WebsiteSale):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        attributes = ProductAttribute.search([('id','in',attributes.ids),('use_in_filter','=',True),('display_type','not in',['text','textarea'])])
        ...
        if attributes:
            ...
            if temp_prod_list:
                attrs_desc_line_rec = request.env['product.attribute_desc.lines'].search([('product_tmpl_id','in',temp_prod_list.ids)])
                ...
                attrs_line_rec = request.env['product.template.attribute.line'].search([('product_tmpl_id','in',temp_prod_list.ids)])
                if attrs_line_rec:
        ...
        attributes = ProductAttribute.search([('id','in',valid_attr_list)], order='sort_order, name')
